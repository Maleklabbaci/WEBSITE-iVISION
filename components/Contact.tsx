...
const Contact: React.FC<ContactProps> = ({ translations }) => {
  ...
  return (
    <section id="contact" ref={sectionRef} className="contact-section py-24 md:py-40 bg-white/0 dark:bg-transparent relative border-t border-navy/5 dark:border-white/5 overflow-hidden transition-colors duration-500">
