...
const getUnsplashUrl = (baseUrl: string, width: number) => {
          ...
          {showcaseImages.map((img, index) => {
            ...
            return (
              <figure 
                ...
                className={`${img.span} relative group overflow-hidden rounded-[2.5rem] border border-white/5 bg-brand-dark/40 transition-all duration-[1200ms] ease-[cubic-bezier(0.2,0.8,0.2,1)] outline-none focus-visible:ring-4 focus-visible:ring-brand-accent focus-visible:ring-offset-4 focus-visible:ring-offset-brand-dark ${isVisible ? 'opacity-100 scale-100 translate-y-0 rotate-0' : 'opacity-0 scale-95 translate-y-12 rotate-1'}`}
              ...
              >
                <img 
                  ...
                  className="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-110 group-focus:scale-110"
                  loading="lazy"
                />
