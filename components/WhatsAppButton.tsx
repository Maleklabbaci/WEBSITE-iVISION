...
const WhatsAppButton: React.FC<WhatsAppButtonProps> = ({ phoneNumber, message }) => {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 left-8 md:left-12 z-40 group"
    ...
    >
      ...
      {/* Tooltip Label */}
      <div className="absolute left-full ml-4 top-1/2 -translate-y-1/2 px-3 py-1 bg-brand-dark/80 backdrop-blur-md border border-white/10 rounded-lg text-white text-xs font-bold whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none hidden md:block">
        WhatsApp
      </div>
    </a>
  );
